...
import           Utils                           (applyEach, conscatM, mconscat)
...
rewriteMsg :: Map ByteString ByteString -> ([ByteString] -> [Maybe ByteString])
...
rewriteHdr :: Map ByteString ByteString -> ([ByteString] -> [Maybe ByteString])
...
-- 'Nothing'.
extractKeywords :: Map ByteString ByteString -> ByteString
